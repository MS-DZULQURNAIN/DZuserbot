...
async def generate_session(bot: Client, msg: Message, telethon=False, is_bot: bool = False):
    ...
    await bot.send_message(msg.chat.id, "String {} berhasil diambil. \n\nSilakan cek di PESAN TERSIMPAN \n\nBy @MsSTRINGbot".format("telethon" if telethon else "pyrogram"))
